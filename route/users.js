...
async function updateWebHook(docs){
    ...
    await KycModel.findOneAndUpdate({customercode:docs.customer_code},{event:docs.event});
    console.log('Done',docs.event);
    console.log('Customercode',docs.customer_code)
